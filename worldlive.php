    ...
    $.get("https://api.covid19api.com/summary",
      ...
      function(data){
        ...
        for(var i=1; i<(data['Countries'].length);
          ...
          tbval.rows[i].cells[0].style.background='#F90000';
          ...
          tbval.rows[i].cells[3];
          tbval.rows[i].cells[3].style.color='#f54b42';
